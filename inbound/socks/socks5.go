...
// SocksServerConfig is used to setup and configure a Server
...
// NewSocks5Server creates a new Server and potentially returns an error
func NewSocks5Server(conf *SocksServerConfig) (*Server, error) {
...
func (s *Server) ServeConn(conn net.Conn) error {
	...
	if _, err := bufConn.Read(version); err != nil {
		common.Errorf("[ERR] socks: Failed to get version byte: %v", err)
		return err
	}
